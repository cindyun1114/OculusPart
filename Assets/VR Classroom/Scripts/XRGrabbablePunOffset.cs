...
public class XRGrabbablePunOffset : UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable
{
    ...
    protected override void OnSelectEntered(SelectEnterEventArgs args)
    {
        ...
        if (args.interactor.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRSocketInteractor>() != null) return;
